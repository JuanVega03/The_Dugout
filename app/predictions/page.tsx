    ...
    <div className="py-3 flex items-center justify-between">
      <div className="flex items-center gap-3 flex-1">
        ...
        <div>
          ...
          <div className="text-[11px] text-gray-500">{label} &middot; ML {formatML(side.moneyline)}</div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a]">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        {data?.date && <p className="text-[10px] text-gray-500 font-mono mt-2">{new Date(data.date+"T12:00:00").toLocaleDateString("en-US",{weekday:"long",month:"long",day:"numeric",year:"numeric"})} &middot; Algorithm v{data.algorithm_version}</p>}
      ...
      <footer className="border-t border-white/5 py-8 mt-12"><div className="max-w-5xl mx-auto px-6 text-center"><p className="text-[10px] text-gray-600 font-mono">THE DUGOUT &middot; Algorithm-powered MLB analytics</p></div></footer>
    </div>
  )
}
