    ...
    <div className="min-h-screen bg-[#0a0f1a]">
      ...
      <div className="max-w-6xl mx-auto px-6 mb-12">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/predictions" className="text-xs text-gray-400 hover:text-yellow-400 transition-colors">View All →</Link>
        </div>
        {isLoading ? (
              ...
              return (
                <div key={i} className={`bg-white/[0.03] border ${tier.border} rounded-xl p-5 hover:bg-white/[0.05] transition-all`}>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="text-center"><div className="text-[10px] text-gray-500 font-mono">MODEL</div><div className="text-base font-black text-green-400 font-mono">{formatPct(pick.model_win_pct)}</div></div>
                    <div className="text-center"><div className="text-[10px] text-gray-500 font-mono">EDGE</div><div className={`text-base font-black font-mono ${(pick.edge_pct||0) > 0 ? "text-green-400" : "text-red-400"}`}>{formatEdge(pick.edge_pct)}</div></div>
                    <div className="text-center"><div className="text-[10px] text-gray-500 font-mono">ML</div><div className="text-base font-bold text-white font-mono">{formatML(pick.moneyline)}</div></div>
                  </div>
                </div>
              )
            })}
      ...
      <footer className="border-t border-white/5 py-8">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <p className="text-[10px] text-gray-600 font-mono">THE DUGOUT · Algorithm-powered MLB analytics</p>
